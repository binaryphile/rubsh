...
underlying bash semantics are unchanged, so you can mix rubsh
with regular bash and make it just a bit rubbish.  Or you can go full
rubsh, which will make it look a bit more like ruby and just confuse the
hell out of bashers and rubyists alike.
